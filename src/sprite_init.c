...
DigitSprites copycatPlayer1ScoreDigitSprites;
DigitSprites copycatPlayer2ScoreDigitSprites;
DigitSprites levelScoreSprite;
DigitSprites levelTimeLeftDigitSprites;
DigitSprites timeAttackPlayer1CurLevelTimeDigitSprites;
DigitSprites timeAttackPlayer1TotalPlaytimeDigitSprites;
DigitSprites timeAttackPlayer2CurLevelTimeDigitSprites;
DigitSprites timeAttackPlayer2TotalPlaytimeDigitSprites;
DigitSprites totalScoreSprite;
TSprite bonusWidgetSpritesMsbBackground[2][34];
TSprite bonusWidgetSpritesMsbForeground[2][32];
TSprite bonusWidgetSpritesPiechart[2][9];
TSprite copyrightSprite[2];
TSprite fruitBonusTextSprites[2][10];
TSprite fruitSprites[2][10];
TSprite keySprites[2][8];
