...
SVECTOR fruit4ScreenSpaceParticlesPos = { 278, 232, -1, 0 };
SVECTOR fruit5ScreenSpaceParticlesPos = { 299, 234, -1, 0 };
SVECTOR transporterParticlesPos = { 160, 180, -1, 0 };
SVECTOR unusedParticlesPos1 = { 160, 112, -1, 0 };
SVECTOR unusedParticlesPos2 = { 160, 240, -1, 0 };
int curController = 0;
int gameMode = 0;
short turnDelayEnabled = 1;
short padCross = 0;
short padUp = 0;

ItemState itemState[256];
short copycatMoves[1024];
